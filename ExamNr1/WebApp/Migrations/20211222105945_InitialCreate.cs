    ...
    public partial class InitialCreate : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_PizzaTopings", x => x.Id);
                    table.ForeignKey(
                        name: "FK_PizzaTopings_Pizzas_PizzaId",
                        column: x => x.PizzaId,
                        principalTable: "Pizzas",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_PizzaTopings_Toppings_ToppingId",
                        column: x => x.ToppingId,
                        principalTable: "Toppings",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ExtraToppings_OrderPizzas_OrderPizzaId",
                        column: x => x.OrderPizzaId,
                        principalTable: "OrderPizzas",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_ExtraToppings_Toppings_ToppingId",
                        column: x => x.ToppingId,
                        principalTable: "Toppings",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ExtraToppings_OrderPizzaId",
                table: "ExtraToppings",
                column: "OrderPizzaId");

            migrationBuilder.CreateIndex(
                name: "IX_ExtraToppings_ToppingId",
                table: "ExtraToppings",
                column: "ToppingId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PizzaTopings_PizzaId",
                table: "PizzaTopings",
                column: "PizzaId");

            migrationBuilder.CreateIndex(
                name: "IX_PizzaTopings_ToppingId",
                table: "PizzaTopings",
                column: "ToppingId");
        }
